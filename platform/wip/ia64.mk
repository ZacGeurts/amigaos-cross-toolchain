# ia64.mk
# Platform-specific versions and build rules for IA-64 cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=ia64
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=ia64
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=ia64
