# dreamcast.mk
# Platform-specific versions and build rules for Dreamcast cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=dreamcast
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=dreamcast
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=dreamcast
