# armv6.mk
# Platform-specific versions and build rules for ARMv6 cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=armv6
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=armv6
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=armv6
