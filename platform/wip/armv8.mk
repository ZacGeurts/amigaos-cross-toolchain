# armv8.mk
# Platform-specific versions and build rules for ARMv8 cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=armv8
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=armv8
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=armv8
