# aarch64.mk
# Platform-specific versions and build rules for AArch64 cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=aarch64
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=aarch64
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=aarch64
