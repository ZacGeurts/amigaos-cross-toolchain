# ps2.mk
# Platform-specific versions and build rules for PlayStation 2 cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=ps2
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=ps2
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=ps2
