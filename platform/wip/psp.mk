# psp.mk
# Platform-specific versions and build rules for PlayStation Portable (PSP) cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=psp
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=psp
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=psp
