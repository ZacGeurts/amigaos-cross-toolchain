# armv7.mk
# Platform-specific versions and build rules for ARMv7 cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=armv7
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=armv7
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=armv7
