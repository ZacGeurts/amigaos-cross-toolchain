# topplatform-ppc.mk
# Platform-specific versions and build rules for TopPlatform PPC cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=topplatform-ppc
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=topplatform-ppc
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=topplatform-ppc
