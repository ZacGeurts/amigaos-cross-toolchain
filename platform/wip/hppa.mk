# hppa.mk
# Platform-specific versions and build rules for HPPA cross-compiling
...
# VERSIONS[opengl]=<version>=<url>=<filename>=hppa
# Example for SDL support:
# VERSIONS[sdl]=<version>=https://libsdl.org/release/SDL-<version>.tar.gz=SDL-<version>.tar.gz=hppa
# VERSIONS[sdl2]=<version>=https://libsdl.org/release/SDL2-<version>.tar.gz=SDL2-<version>.tar.gz=hppa
